<?php
	...
	if($cart_query){
		...
		$tieude = "Đặt hàng website huyshop.com thành công!";
		...
		foreach($_SESSION['cart'] as $key => $val){
			$noidung.= "<table style='border:1px solid blue;margin:10px;'>
			<tr>
				<th>".$val['tensanpham']."</th>
				<th>".$val['masp']."</th>
				<th>".number_format($val['giasp'],0,',','.')."đ</th>
				<th>".$val['soluong']."</th>
			</tr>
				</table>";
